...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fkuhlmann_trollhorde.bot' => 'getFkuhlmannTrollhorde_BotService',
            'fkuhlmann_trollhorde.horde' => 'getFkuhlmannTrollhorde_HordeService',
            'fkuhlmann_trollhorde.target' => 'getFkuhlmannTrollhorde_TargetService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'horde_of_trolls', 'user' => 'horde_of_trolls', 'password' => 'horde_of_trolls', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Fkuhlmann/TrollhordeBundle/Resources/config/doctrine') => 'Fkuhlmann\\TrollhordeBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Fkuhlmann\\TrollhordeBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('FkuhlmannTrollhordeBundle' => 'Fkuhlmann\\TrollhordeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0d67154bf39dbcc8ddf5619ff8994e01a0d1304065422b8cc74d074c1fc56f28');
    ...
    /**
     * Gets the 'fkuhlmann_trollhorde.bot' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fkuhlmann\TrollhordeBundle\Models\Bot A Fkuhlmann\TrollhordeBundle\Models\Bot instance
     */
    protected function getFkuhlmannTrollhorde_BotService()
    {
        return $this->services['fkuhlmann_trollhorde.bot'] = new \Fkuhlmann\TrollhordeBundle\Models\Bot($this);
    }

    /**
     * Gets the 'fkuhlmann_trollhorde.horde' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fkuhlmann\TrollhordeBundle\Models\Horde A Fkuhlmann\TrollhordeBundle\Models\Horde instance
     */
    protected function getFkuhlmannTrollhorde_HordeService()
    {
        return $this->services['fkuhlmann_trollhorde.horde'] = new \Fkuhlmann\TrollhordeBundle\Models\Horde($this);
    }

    /**
     * Gets the 'fkuhlmann_trollhorde.target' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fkuhlmann\TrollhordeBundle\Models\Target A Fkuhlmann\TrollhordeBundle\Models\Target instance
     */
    protected function getFkuhlmannTrollhorde_TargetService()
    {
        return $this->services['fkuhlmann_trollhorde.target'] = new \Fkuhlmann\TrollhordeBundle\Models\Target($this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Fkuhlmann/TrollhordeBundle/Resources/views'), 'FkuhlmannTrollhorde');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('34d5f030a386938156dccf567e789de51ac7de7f');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58cfbd392ed4d6.74439931')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FkuhlmannTrollhordeBundle' => 'Fkuhlmann\\TrollhordeBundle\\FkuhlmannTrollhordeBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'FkuhlmannTrollhordeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Fkuhlmann/TrollhordeBundle'),
            ...
            'database_port' => NULL,
            'database_name' => 'horde_of_trolls',
            'database_user' => 'horde_of_trolls',
            'database_password' => 'horde_of_trolls',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '34d5f030a386938156dccf567e789de51ac7de7f',
            'locale' => 'en',
            ...
            'kernel.secret' => '34d5f030a386938156dccf567e789de51ac7de7f',
            ...
            'fkuhlmann_trollhorde.twitter' => array(
                'target' => array(
                    'owner' => 'fkuhlmann',
                    'owner_id' => 'FALSE',
                    'consumer_key' => 'MgkIMWKhnIIVsbaPauXou9zSt',
                    'consumer_secret' => 'w4DIieUpuBtAoi0nKwGMegy6vWx4urvXzNcIHG8p4h9wEjc0nv',
                    'access_token' => '44167852-AfsJR2ubaeupzL5uNYOuzZMoYdql4i1vD64ZKhYj0',
                    'access_token_secret' => 'g6h6ZKP2KGkVjukj8dh4CkXnsAEUuXy4XdeX8OiamZFWw',
                ),
                'bots' => array(
                    'bot_1' => array(
                        'owner' => 'theVeryRudeOne',
                        'owner_id' => '829841249259704320',
                        'consumer_key' => 'Iipzlbd6J0j5IetfPoIVZAwgl',
                        'consumer_secret' => 'Fwc0SgQj1RtaGEiditgW9aTF3VdzjG2i0TIOSVmHy2npIM1MOE',
                        'access_token' => '829841249259704320-ceTXVIP6ZHghCudL38lzipZocVrONaq',
                        'access_token_secret' => '3wyHcfwBhE0yZq7Ma8IRkLSDq9WHt58xWjTxBlHaudQVa',
                    ),
                    'bot_2' => array(
                        'owner' => 'theVeryFunnyOne',
                        'owner_id' => '831267750794379268',
                        'consumer_key' => 'MikVcxL7RXyPJzO8AaZXITpzR',
                        'consumer_secret' => 'ZPngxB9VFF91I2AbjPH96N2LrglshLycHa6JkrGehXlw61wpKU',
                        'access_token' => '831267750794379268-E9yGdftomR6tSC78MjBswFVbMoK5PKC',
                        'access_token_secret' => '7cjbF9nzpBtKSiRSbRraHqp1HKibOgL6AcYQ1yzqjfQIY',
                    ),
                    'bot_3' => array(
                        'owner' => 'theLOLingOne',
                        'owner_id' => '831272675620356098',
                        'consumer_key' => '2y8lnm7SDL5NtV4ptKjPNGdRp',
                        'consumer_secret' => 'Y9DBDQooYk4tLhI9vEdie1nkMnWOZlLHw6TvCf2uBt6ZCLDnQT',
                        'access_token' => '831272675620356098-syEZkpLzdvpxqejXwZQDCtZ9h5XwPoq',
                        'access_token_secret' => 'C0RpBR4VK5McLMxKmGyrPLuAj7KJJkoL0mBG7OxVAHHMU',
                    ),
                    'bot_4' => array(
                        'owner' => 'theShoutingOne',
                        'owner_id' => '831285712989323264',
                        'consumer_key' => 'FHpqJEWimzeM335razWHS9RXA',
                        'consumer_secret' => 'LfKLCOCUCQO5qXAxiwdwMTFllHmPbcP4Qmy2yjGA2GT9SN5imj',
                        'access_token' => '831285712989323264-eUhZSywzlLqo9LytNvPghCu6WaFzzCw',
                        'access_token_secret' => 'mDH0BWJtIWAa4jMoeyqmkr4dvh3H5sLbTm0lN53Sye8bH',
                    ),
                ),
            ),
            'fkuhlmann_trollhorde.twitter.target' => array(
                'owner' => 'fkuhlmann',
                'owner_id' => 'FALSE',
                'consumer_key' => 'MgkIMWKhnIIVsbaPauXou9zSt',
                'consumer_secret' => 'w4DIieUpuBtAoi0nKwGMegy6vWx4urvXzNcIHG8p4h9wEjc0nv',
            ...
            'fkuhlmann_trollhorde.twitter.bots' => array(
                'bot_1' => array(
                    'owner' => 'theVeryRudeOne',
                    'owner_id' => '829841249259704320',
                    'consumer_key' => 'Iipzlbd6J0j5IetfPoIVZAwgl',
